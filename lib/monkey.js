...
/*
 * This is required to make restify work with i18n-abide. Basically it adds the missing
 * res.locals which i18n-abide uses to poke template vars onto to be used in views.
 */

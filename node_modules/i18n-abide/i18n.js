...
var i18n = module.exports = function(options) {
  ...
  return {
    checkUrlLocale: checkUrlLocale,

    localizationContext: function(contextSettings) {

      var langs = parseAcceptLanguage(contextSettings.acceptLang),
          lang_dir,
      ...
      locals.setLocale = function(req, resp, assignedLocale) {
      ...
      context.setLocale = locals.setLocale;
 ...
 */
i18n.abide = function(options) {
  var abide = i18n(options);
  abide.checkUrlLocale(req);
  var context = abide.localizationContext(req.headers['accept-language']);

  return function(req, resp, next) {
    var formatFnName = 'format';
    if (!! context.locals.format || !! req.format) {
    ...
    context.locals[formatFnName] = format;
    req[formatFnName] = format;
    req.setLocale = context.setLocale.bind(req, resp)
 ...
 * }
 */
i18n.parseAcceptLanguage = parseAcceptLanguage = function(header) {
...
i18n.bestLanguage = bestLanguage = function(languages, supported_languages, defaultLanguage) {
 ...
 * locale:   en_US
 */
i18n.localeFrom = localeFrom = function(language) {
 ...
 */
i18n.languageFrom = languageFrom = function(locale) {
 ...
 */
i18n.format = format = function(fmt, obj, named) {
  if (!fmt) return "";
